...
File containing [key with which transactions are signed](../../HowTo/Get-Started/Getting-Started.md#create-password-and-key-files).  
...
File containing password for the [key with which transactions are signed](../../HowTo/Get-Started/Getting-Started.md#create-password-and-key-files).  
